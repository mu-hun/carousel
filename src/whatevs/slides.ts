...
const slides = [
  {
    ...
    content: `At the center of the photo, a monster young star 200,000 times brighter
  ...
  },
  {
    ...
    content: `For the 26th birthday of NASA's Hubble Space Telescope, astronomers are
  ...
  },
  {
    img: img2,
    title: 'Eagle Nebula',
    content: `The Eagle Nebula pillars are bathed in the blistering ultraviolet light
